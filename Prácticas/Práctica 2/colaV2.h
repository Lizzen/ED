/*
NOMBRE Y APELLIDOS PRIMER INTEGRANTE DEL GRUPO: Álvaro Gómez Tejedor 
...
public:
    /* COMPLEJIDAD: Determina justificadamente la complejidad de esta operación
		...
		por lo tanto recorre n elementos y el tiempo de ejecución
		es proporcional al número de elementos que hay en la cola.
	*/
    void penalizaSecuencia(int inicio, int fin) {
		/*  A IMPLEMENTAR */
		if (esVacia() || fin < inicio) {
			return;
		}

		Nodo* act = _prim, *ant = nullptr, *sig = nullptr, *nodo_ini = nullptr;
