...
class InfoCiudadano {
public:
    InfoCiudadano(tAnio anio, bool solicitado) :
        anio(anio), solicitado(solicitado) {};
    tAnio anio;
    bool solicitado;
};
...
class InfoCentro {
public:
    InfoCentro(tDireccion dir, Lista<tIdCiudadano> l_ciu) :
        dir(dir), l_ciu(l_ciu) {};
    tDireccion dir;
    Lista<tIdCiudadano> l_ciu;
};
...
private:  
   // A INCLUIR DETALLES DE REPRESENTACION
    tAnio anioLc;
    tNumVacunas num_vacunas;
    Diccionario<tIdCentro, InfoCentro> reg_centro = Diccionario<tIdCentro, InfoCentro>();
    DiccionarioHash<tIdCiudadano, InfoCiudadano> reg_ciudadano = DiccionarioHash<tIdCiudadano, InfoCiudadano>();
    Lista<tIdCiudadano> solicitudes = Lista<tIdCiudadano>();
};
